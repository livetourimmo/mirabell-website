...
const IMAGES: GalleryImage[] = [
  { id: "referenz", label: "Referenzansicht Abendstimmung", src: "/images/hero-platzhalter.jpg", className: "md:col-span-4 md:row-span-2 aspect-[4/3] md:aspect-auto" },
  { id: "aussen-b", label: "Platzhalter: Aussenansicht Haus B", src: null, className: "md:col-span-2 aspect-[4/3]" },
  { id: "interieur", label: "Platzhalter: Eichenparkett, Wohnbereich", src: null, className: "md:col-span-2 aspect-[4/3]" },
  { id: "aussicht", label: "Platzhalter: Blick Richtung Obersee", src: null, className: "md:col-span-3 aspect-[16/10]" },
  { id: "fassade", label: "Platzhalter: Fassadendetail, Grobputz", src: null, className: "md:col-span-3 aspect-[16/10]" },
];
        ...
        {IMAGES.map((image) => (
          ...
          >
            {image.src ? (
              ...
              <PlaceholderMedia label={image.label} className="h-full w-full" aspect="" />
            )}
          </button>
        ))}
      </div>
