...
export const MOCK_DOWNLOADS: DownloadItem[] = [
  ...
  { id: "situationsplan", titel: "Situationsplan", beschreibung: "Lage der Baukörper auf dem Grundstück.", dateityp: "PDF", dateigroesse: "25.2 MB", url: "/downloads/Mirabell-Situationsplan.pdf" },
